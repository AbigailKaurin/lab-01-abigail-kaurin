...
the three variables are:**dataset**: indicates which dataset the data are from, **x**: x-values, and **y** : y-values
...
the correlation coefficient for **x** and **y** in the star data set is -0.0630, as opposed to the r of dino, which was 0.0645
...
I was able to plot the star dataset but for some reason when I try doing the same things I can't get the circle to appear or calculate the correlation
